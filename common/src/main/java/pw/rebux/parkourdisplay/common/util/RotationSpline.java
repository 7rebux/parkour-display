...
public final class RotationSpline {
  ...
  public float valueAt(float partialTicks) {
    ...
    var incoming = MathUtil.wrapDegrees(this.previous - this.from);
    var end = MathUtil.wrapDegrees(this.to - this.from);
    var outgoing = end + MathUtil.wrapDegrees(this.following - this.to);
